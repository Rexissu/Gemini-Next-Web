...
const GlobalLayout: React.FC<{
    ...
    useEffect(() => {
        ...
        window.addEventListener('toggleRightDrawer', handleToggleRightDrawer);
        return () => {
            window.removeEventListener('toggleRightDrawer', handleToggleRightDrawer);
        };
    }, []);
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    >
                        <path
                            d='M18.1591 17.0322C18.1163 17.5027 18.2662 17.9782 18.5859 18.326C18.9055 18.6737 19.357 18.8578 19.7673 19.0214C20.2154 19.1987 20.6027 19.3436 21.0212 19.5941C21.4199 19[...]
                            fill='#87A9FF'
                        ></path>
                        <path
                            d='M19.886 15.6415C20.3358 15.3756 20.756 15.1881 21.2453 15.0142C21.7166 14.8472 22.196 14.7091 22.6805 14.5847C23.1633 14.4603 23.651 14.3546 24.1387 14.2489C24.6264 14.1[...]
                            fill='#0057CE'
                        ></path>
                        <path
                            d='M9.62059 17.1674C9.46241 16.9867 9.29764 16.8145 9.11474 16.6611C9.34212 17.06 9.36519 17.5117 9.26962 17.9463C9.17406 18.3793 8.96315 18.7799 8.69622 19.1242C8.42105 19[...]
                            fill='#87A9FF'
                        ></path>
                        <path
                            d='M4.45504 6.30371C6.13076 6.30201 7.75705 7.25484 8.93516 8.32358C10.1858 9.45879 11.1546 10.9042 11.7923 12.4758C12.4332 14.0559 12.7414 15.7638 12.7298 17.4701C12.7183 [...]
                            fill='#0057CE'
                        ></path>
                    </svg>
                </div>
